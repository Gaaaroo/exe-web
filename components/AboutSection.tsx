        ...
        <div className="space-y-4">
          ...
          >
            ...
            <p className="font-body text-parchment/80 text-sm leading-relaxed">
              ...
              trực tiếp làm nghề, khám phá ký ức và điều chỉnh mức độ kinh dị dân gian sao cho phù hợp
              với trải nghiệm của riêng mình.
            </p>
          </motion.div>
          ...
          >
            ...
            <ul className="font-body text-parchment/75 text-sm space-y-1.5 list-disc list-inside">
              ...
              <li>Kết hợp giải trí, kinh dị dân gian và giáo dục văn hóa trong một trải nghiệm liền mạch</li>
